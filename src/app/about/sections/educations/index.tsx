          ...
          <span className="flex gap-2">
            ...
            {course.institution.website ? (
              <a
                ...
                target="_blank"
                className="group inline-flex items-center underline underline-offset-2 hover:no-underline decoration-blue-500"
              >
                {/* <span>{course.institution.name}</span> */}
                <span className="text-blue-500 mr-2">{course.institution.name}</span>
                <ArrowUpRight
                  size="0.8em"
